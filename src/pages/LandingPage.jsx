          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Unleash Your Inner
                <span className="text-neon-green"> Athlete</span>
              </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
              Transform Your <span className="text-neon-green">Volleyball Journey</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="card hover:scale-105 transition-transform duration-300">
                ...
                <Link to="/register" className="mt-4 btn-secondary w-full text-center block">
                  S'inscrire
                </Link>
              </div>
            ))}
