...
const PlayersList = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    number: '',
    phone: '',
    photo: defaultPlayerPhoto,
  });

  const [photoPreview, setPhotoPreview] = useState(defaultPlayerPhoto);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ CORRECTION : ENVOYER SEULEMENT LES CHAMPS ESSENTIELS
      const dataToSend = {
        name: formData.name,
        ...
        // ❌ NE PAS ENVOYER photo et cv POUR L'INSTANT
      };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    max="99"
                    placeholder="Utilisez un numéro élevé comme 99"
                  />
                </div>
